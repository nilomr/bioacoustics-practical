...
# NOTE : changing working directories like this is a bad programming practice,
# but necessary here due to a bug in the package that we are going to use
setwd(files_dir)
...
write.csv(element_list, file.path(maindir, "data", "song-segmentation.csv"), row.names = FALSE)
```
